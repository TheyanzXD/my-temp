...
| `CUSTOM_DOMAINS` | Comma-separated domains for webhook provider | `temp.yaoi.web.id` |
| `APP_NAME` | Display name | `MyTemp` |
| `APP_URL` | Public URL | `https://temp.yaoi.web.id` |
...
2. Add `temp.yaoi.web.id` (or your domain)
